...
\begin{frame}{搜索工具}
	...
	\begin{itemize}
		...
		\item ChatGPT（\url{https://poe.com}、\url{https://chat.vercel.ai}）
	\end{itemize}
...
\begin{frame}{安装JupyterLab}
	强力建议创建并启动\href{https://docs.python.org/3/tutorial/venv.html}{虚拟环境}后再安装第三方包。\texttt{python -m venv ThePath}
	\begin{block}{第0步}
