...

{
	...
	\begin{frame}
		...
		\href{https://www.python.org/doc/essays/foreword/}{Python的由来}
	\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{tikzpicture}[scale=.75]
			\begin{axis}[
					xlabel=\href{https://www.tiobe.com/tiobe-index/}{Tiobe} 2025年10月编程语言排名,
					...
					enlarge y limits=.2,
					xbar,
					xmin=0, xmax=30, xtick distance=3
				]
				\addplot
				coordinates {
						(24.45,Python)
		...
		\begin{tikzpicture}[scale=.75]
			\begin{axis}[
					xlabel=\href{https://survey.stackoverflow.co/2025/}{StackOverFlow} 2025年语言排名,
					symbolic y coords={JavaScript, HTML\slash{CSS}, Python, SQL, Bash\slash{Shell}},
					major y tick style = transparent,
					xmajorgrids=true,
					bar width=10pt,
					enlarge y limits=.2,
...
\begin{frame}
	...
	\begin{columns}
		...
		\href{https://www.reddit.com/r/ProgrammerHumor/comments/m3pf9h/there_is_only_one_king/}{This is Only One King}
...
\begin{frame}{搜索工具}
	...
	\begin{itemize}
		...
		\item ChatGPT, Claude, Github Copilot
		\item \texttt{help()}、\texttt{?}
	\end{itemize}
...
\begin{frame}
	\frametitle{编程工具}
	本课程推荐使用\alert{Python 3.10+}。IDE或编辑器（要求掌握）：
	\begin{itemize}
		\item PyCharm （适合专业、大型项目）或 VSCode （适合轻量级、小型项目）
